...
public interface RunSetResultFullReferenceMapper {

    long countByExample(RunSetResultExample example);

    List<RunSetResult> selectByExample(RunSetResultExample example);

    List<RunSetResult> selectByExampleSelective(@Param("example") RunSetResultExample example,
            @Param("selective") RunSetResult.Column... selective);
    ...
    RunSetResult selectByPrimaryKeySelective(@Param("id") Long id,
            @Param("selective") RunSetResult.Column... selective);

    RunSetResult selectOneByExample(RunSetResultExample example);

    RunSetResult selectOneByExampleSelective(@Param("example") RunSetResultExample example,
            @Param("selective") RunSetResult.Column... selective);
