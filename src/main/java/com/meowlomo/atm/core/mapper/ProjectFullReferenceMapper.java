...
public interface ProjectFullReferenceMapper {

    long countByExample(ProjectExample example);

    List<Project> selectByExample(ProjectExample example);

    List<Project> selectByExampleSelective(@Param("example") ProjectExample example,
            @Param("selective") Project.Column... selective);
    ...
    Project selectOneByExampleSelective(@Param("example") ProjectExample example,
            @Param("selective") Project.Column... selective);
