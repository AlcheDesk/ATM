...
public class TestCaseModuleLink implements Serializable {
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        TestCaseModuleLink other = (TestCaseModuleLink) that;
    ...
    public enum Column {
        id("id", "id", "BIGINT", false), testCaseId("test_case_id", "testCaseId", "BIGINT", false), moduleId("module_id", "moduleId", "BIGINT", false);
