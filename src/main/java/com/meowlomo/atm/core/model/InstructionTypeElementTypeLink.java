...
public class InstructionTypeElementTypeLink implements Serializable {
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        InstructionTypeElementTypeLink other = (InstructionTypeElementTypeLink) that;
    ...
    public enum Column {
        id("id", "id", "BIGINT", false), instructionType("instruction_type_id", "instructionType", "OTHER", false), elementType("element_type_id", "elementType", "OTHER", false);
