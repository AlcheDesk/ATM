...
public class TestCaseTagLink implements Serializable {
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        TestCaseTagLink other = (TestCaseTagLink) that;
    ...
    public enum Column {
        id("id", "id", "BIGINT", false), testCaseId("test_case_id", "testCaseId", "BIGINT", false), tagId("tag_id", "tagId", "BIGINT", false);
