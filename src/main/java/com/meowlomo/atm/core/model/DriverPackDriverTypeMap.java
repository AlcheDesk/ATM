...
public class DriverPackDriverTypeMap implements Serializable {
    private Long id;
    ...
    public void setDriverPackId(Long testCaseId) {
    ...
    public boolean equals(Object that) {
        ...
        DriverPackDriverTypeMap other = (DriverPackDriverTypeMap) that;
