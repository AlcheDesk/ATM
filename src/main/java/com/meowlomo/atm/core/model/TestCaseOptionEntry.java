...
public class TestCaseOptionEntry implements Serializable {
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        TestCaseOptionEntry other = (TestCaseOptionEntry) that;
    ...
    public enum Column {
        id("id", "id", "BIGINT", false), name("name", "name", "VARCHAR", false), value("value", "value", "VARCHAR", false), testCaseId("test_case_id", "testCaseId", "BIGINT",
                false), valueRequired("is_value_required", "valueRequired", "BIT", false);
