...
public class DriverVendor implements Serializable {
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        DriverVendor other = (DriverVendor) that;
    ...
    public enum Column {
        id("id", "id", "BIGINT", false), name("name", "name", "VARCHAR", false), driverType("driver_type_id", "driverType", "OTHER", false), version("version", "version",
                "VARCHAR", false), active("is_active", "active", "BIT", false), predefined("is_predefined", "predefined", "BIT", false);
