...
public class RunSetNotificationLink implements Serializable {
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        RunSetNotificationLink other = (RunSetNotificationLink) that;
    ...
    public enum Column {
        id("id", "id", "BIGINT", false), runSetId("run_set_id", "runSetId", "BIGINT", false), notificationId("notification_id", "notificationId", "BIGINT", false);
