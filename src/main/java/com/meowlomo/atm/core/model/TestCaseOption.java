...
public class TestCaseOption implements Serializable {
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        TestCaseOption other = (TestCaseOption) that;
    ...
    public enum Column {
        id("id", "id", "BIGINT", false), name("name", "name", "VARCHAR", false), updatedAt("updated_at", "updatedAt", "TIMESTAMP", false), createdAt("created_at", "createdAt",
                "TIMESTAMP", false), comment("comment", "comment", "VARCHAR", false), valueRequired("is_value_required", "valueRequired", "BIT",
                        false), active("is_active", "active", "BIT", false), predefined("is_predefined", "predefined", "BIT", false);
