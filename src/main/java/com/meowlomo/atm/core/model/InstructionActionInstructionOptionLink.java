...
public class InstructionActionInstructionOptionLink implements Serializable {
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        InstructionActionInstructionOptionLink other = (InstructionActionInstructionOptionLink) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                ...
                && (this.getInstructionOption() == null ? other.getInstructionOption() == null : this.getInstructionOption().equals(other.getInstructionOption()));
    }
    ...
    public enum Column {
        id("id", "id", "BIGINT", false), instructionAction("instruction_action_id", "instructionAction", "OTHER", false), instructionOption("instruction_option_id",
                "instructionOption", "OTHER", false);
