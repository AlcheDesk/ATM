...
public class DriverPackDriverLink implements Serializable {

    private Long id;

    @NotNull(message = "driverPackId不能为空")
    ...
    public boolean equals(Object that) {
        ...
        DriverPackDriverLink other = (DriverPackDriverLink) that;
    ...
    public enum Column {
        id("id", "id", "BIGINT", false), driverPackId("driver_pack_id", "driverPackId", "BIGINT", false), driverId("driver_id", "driverId", "BIGINT",
                false), driverAlias("driver_alias", "driverAlias", "VARCHAR", false);
