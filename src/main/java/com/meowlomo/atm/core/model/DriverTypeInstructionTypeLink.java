...
public class DriverTypeInstructionTypeLink implements Serializable {
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        DriverTypeInstructionTypeLink other = (DriverTypeInstructionTypeLink) that;
    ...
    public enum Column {
        id("id", "id", "BIGINT", false), driverType("driver_type_id", "driverType", "OTHER", false), instructionType("instruction_type_id", "instructionType", "OTHER", false);
