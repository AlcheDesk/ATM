...
public class TestCaseDriverAliasMap implements Serializable {
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        TestCaseDriverAliasMap other = (TestCaseDriverAliasMap) that;
    ...
    public enum Column {
        id("id", "id", "BIGINT", false), testCaseId("test_case_id", "testCaseId", "BIGINT", false), driverAliases("driver_aliases", "driverAliases", "ARRAY", false);
