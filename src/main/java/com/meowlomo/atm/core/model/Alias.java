...
public class Alias implements Serializable {
    ...
    public enum Column {
        id("id", "id", "BIGINT", false), name("name", "name", "VARCHAR", false), comment("comment", "comment", "VARCHAR", false), updatedAt("updated_at", "updatedAt", "TIMESTAMP",
                false), createdAt("created_at", "createdAt", "TIMESTAMP", false), deleted("is_deleted", "deleted", "BIT", false);
