...
public class InstructionTypeInstructionActionLink implements Serializable {
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        InstructionTypeInstructionActionLink other = (InstructionTypeInstructionActionLink) that;
    ...
    public enum Column {
        id("id", "id", "BIGINT", false), instructionType("instruction_type_id", "instructionType", "OTHER", false), instructionAction("instruction_action_id", "instructionAction",
                "OTHER", false);
