...
public class NotFoundExceptionMapper implements ExceptionMapper<NotFoundException> {
    ...
    public Response toResponse(NotFoundException exception) {
        MeowlomoErrorResponse restErrorResponse = new MeowlomoErrorResponse(HttpServletResponse.SC_NOT_FOUND,
                // type
                ...
                Constants.APP_NAME + HttpServletResponse.SC_NOT_FOUND, UUID.randomUUID());
