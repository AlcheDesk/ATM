...
public class CustomInternalServerErrorException extends InternalServerErrorException {
    ...
    public CustomInternalServerErrorException(Exception ex, String message, String trace, String code,
            UUID uuid) {
        this.message = message;
        this.trace = trace;
        this.type = ex == null ? InternalServerErrorException.class.getName() : ex.getClass().getName();
        this.uuid = uuid;
        this.code = code == null ? Constants.APP_NAME + HttpServletResponse.SC_INTERNAL_SERVER_ERROR
                : Constants.APP_NAME + HttpServletResponse.SC_INTERNAL_SERVER_ERROR + code;
