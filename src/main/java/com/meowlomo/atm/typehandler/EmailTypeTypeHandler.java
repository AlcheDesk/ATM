...
public class EmailTypeTypeHandler extends BaseTypeHandler<String> {

    @Override
    public void setNonNullParameter(PreparedStatement ps, int i, String parameter, JdbcType jdbcType)
            throws SQLException {
        Long typeId = RuntimeVariables.getEmailTypeToIdMap().get(parameter);
        if (typeId == null) {
            ps.setLong(i, 0);
        }
        else {
    ...
    public String getNullableResult(ResultSet rs, String columnName) throws SQLException {
        ...
        if (typeId == 0) {
            ...
            return RuntimeVariables.getIdToEmailTypeMap().get(typeId);
        }
    }
