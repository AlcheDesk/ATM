...
public class Task implements Serializable {
    ...
    private UUID synchronizedExecutionUuid;
    ...
    public Boolean getSynchronizedExecution() {
        return synchronizedExecution;
    }

    public void setSynchronizedExecution(Boolean synchronizedExecution) {
        this.synchronizedExecution = synchronizedExecution;
    }

    public UUID getSynchronizedExecutionUuid() {
        return synchronizedExecutionUuid;
    }

    public void setSynchronizedExecutionUuid(UUID synchronizedExecutionUuid) {
        this.synchronizedExecutionUuid = synchronizedExecutionUuid;
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                ...
                && (this.getSynchronizedExecution() == null ? other.getSynchronizedExecution() == null
                        : this.getSynchronizedExecution().equals(other.getSynchronizedExecution()))
                && (this.getSynchronizedExecutionUuid() == null ? other.getSynchronizedExecutionUuid() == null
                        : this.getSynchronizedExecutionUuid().equals(other.getSynchronizedExecutionUuid()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSynchronizedExecution() == null) ? 0 : getSynchronizedExecution().hashCode());
        result = prime * result
                + ((getSynchronizedExecutionUuid() == null) ? 0 : getSynchronizedExecutionUuid().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", synchronizedExecution=").append(synchronizedExecution);
        sb.append(", synchronizedExecutionUuid=").append(synchronizedExecutionUuid);
                                                                                                                                                        ...
                                                                                                                                                        false), singleton(
                                                                                                                                                                ...
                                                                                                                                                                false), externalIdentifier(
                                                                                                                                                                        ...
                                                                                                                                                                        false), singletonUuid(
                                                                                                                                                                                ...
                                                                                                                                                                                "singletonUuid",
                                                                                                                                                                                "OTHER",
                                                                                                                                                                                false), synchronizedExecution(
                                                                                                                                                                                        "synchronized_execution",
                                                                                                                                                                                        "synchronizedExecution",
                                                                                                                                                                                        "BIT",
                                                                                                                                                                                        false), synchronizedExecutionUuid(
