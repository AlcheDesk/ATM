ALTER TABLE "project_execution_info" RENAME COLUMN "total_test_case_number" TO active_test_case_number;
ALTER TABLE "project_report_info" RENAME COLUMN "total_test_case_number" TO active_test_case_number;
----------------------------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------------------------
...
BEGIN
	IF TG_OP = 'UPDATE' THEN
		...
		NEW.active_test_case_number = case when array_length(NEW.test_case_ids, 1) is null then 0 else array_length(NEW.test_case_ids, 1) end;
...
BEGIN
	...
	ELSIF TG_OP = 'UPDATE' THEN
	    ...
	    active_test_case_number = case when array_length(NEW.test_case_ids, 1) is null then 0 else array_length(NEW.test_case_ids, 1) end,
...
BEGIN
	...
	IF TG_OP = 'UPDATE' THEN
		NEW.project_created_at = OLD.project_created_at;
		NEW.failed_test_case_number = NEW.active_test_case_number - NEW.failed_test_case_number;
...
ALTER TABLE "project_execution_info" ADD CONSTRAINT project_execution_info_ck_test_case_numbers CHECK ((active_test_case_number >= executed_test_case_number));